...
#ifndef _TODAY_S_TASKS_SWIFT_H
#define _TODAY_S_TASKS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="_Today_s_tasks",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14_Today_s_tasks17AddViewController")
...
@property (nonatomic, weak) IBOutlet UISegmentedControl * _Null_unspecified durationControl;
- (void)viewDidLoad;
- (void)keyboardWillShowWith:(NSNotification * _Nonnull)notification;
- (void)keyboardWillHideWith:(NSNotification * _Nonnull)notification;
- (IBAction)saveBtnTapped:(UIButton * _Nonnull)sender;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end


@interface AddViewController (SWIFT_EXTENSION(_Today_s_tasks)) <UITextFieldDelegate>
...
SWIFT_CLASS("_TtC14_Today_s_tasks11AppDelegate")
...
SWIFT_CLASS("_TtC14_Today_s_tasks13SceneDelegate")
...
SWIFT_CLASS("_TtC14_Today_s_tasks19TableViewController")
...
@interface Task (SWIFT_EXTENSION(_Today_s_tasks))
